...
const ThisisparkerHigginsPublicDomians: React.FC = () => {
    return (
        <pre style={{ backgroundColor: '#fffacd', color: '#000', textShadow: 'none' }}>
            <code>
                {`
                import string
                import sys
...
export default ThisisparkerHigginsPublicDomians;
